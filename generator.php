...
if (isset($_POST['save'])) {require('save.php');} // Save the current setup to the database
...
function pixopoint_menu_head() {global $variable,$pixopoint_menu_version,$pixopoint_codingengine;
	...
	ob_start();
	if (isset($_POST['open'])) {echo get_option('suckerfish_save');} // load saved design
	...
	// Load Nature
	elseif (isset($_POST['nature'])) {$variable['confirmloading'] = 'Nature';readfile($pixopoint_codingengine.'data.php?id='.get_option('pixo_saved'));require('designs/nature.php');} // Load first menu
	elseif (isset($_POST['nature2'])) {$variable['confirmloading'] = 'Nature';readfile($pixopoint_codingengine.'data.php?id='.get_option('pixo_saved'));require('designs/nature2.php');} // Load second menu

	// Load Bland grey
	elseif (isset($_POST['blandgrey'])) {$variable['confirmloading'] = 'Bland Grey';readfile($pixopoint_codingengine.'data.php?id='.get_option('pixo_saved'));require('designs/blandgrey.php');} // Load first menu
	elseif (isset($_POST['blandgrey2'])) {$variable['confirmloading'] = 'Bland Grey';readfile($pixopoint_codingengine.'data.php?id='.get_option('pixo_saved'));require('designs/blandgrey2.php');} // Load second menu

	// Load Blue berry
	elseif (isset($_POST['blueberry'])) {$variable['confirmloading'] = 'Blue berry';readfile($pixopoint_codingengine.'data.php?id='.get_option('pixo_saved'));require('designs/blueberry.php');} // Load first menu
	elseif (isset($_POST['blueberry2'])) {$variable['confirmloading'] = 'Blue berry';readfile($pixopoint_codingengine.'data.php?id='.get_option('pixo_saved'));require('designs/blueberry2.php');} // Load second menu

	// Load Bland Red
	elseif (isset($_POST['blandred'])) {$variable['confirmloading'] = 'Bland Red';readfile($pixopoint_codingengine.'data.php?id='.get_option('pixo_saved'));require('designs/blandred.php');} // Load first menu
	elseif (isset($_POST['blandred2'])) {$variable['confirmloading'] = 'Bland Red';readfile($pixopoint_codingengine.'data.php?id='.get_option('pixo_saved'));require('designs/blandred2.php');} // Load second menu

	// Load Red Dazzle
	elseif (isset($_POST['reddazzle'])) {$variable['confirmloading'] = 'Red Dazzle';readfile($pixopoint_codingengine.'data.php?id='.get_option('pixo_saved'));require('designs/reddazzle.php');} // Load first menu
	elseif (isset($_POST['reddazzle2'])) {$variable['confirmloading'] = 'Red Dazzle';readfile($pixopoint_codingengine.'data.php?id='.get_option('pixo_saved'));require('designs/reddazzle2.php');} // Load second menu

	// Load Corporate Black
	elseif (isset($_POST['corporateblack'])) {$variable['confirmloading'] = 'Corporate Black';readfile($pixopoint_codingengine.'data.php?id='.get_option('pixo_saved'));require('designs/corporateblack.php');} // Load first menu
	elseif (isset($_POST['corporateblack2'])) {$variable['confirmloading'] = 'Corporate Black';readfile($pixopoint_codingengine.'data.php?id='.get_option('pixo_saved'));require('designs/corporateblack2.php');} // Load second menu

	elseif (get_option('pixo_saved') == 'new') {echo get_option('suckerfish_save');} // If new then load default template
	else {readfile($pixopoint_codingengine.'data.php?id='.get_option('pixo_saved'));} // else load from external server
